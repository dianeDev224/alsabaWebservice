/**
 *getPartenaireCount.js
 */

const response = require('../../utils/response');
/**
 * @description : returns total number of records of partenaire
...
const getPartenaireCount = ({
  ...
  let count = await partenaireDb.count(where);
  return response.success({ data: { count } });
};
module.exports = getPartenaireCount;
/**
 *getCodeMoneyCount.js
 */

const response = require('../../utils/response');
/**
 * @description : returns total number of records of codeMoney
...
const getCodeMoneyCount = ({
  ...
  let count = await codeMoneyDb.count(where);
  return response.success({ data: { count } });
};
module.exports = getCodeMoneyCount;
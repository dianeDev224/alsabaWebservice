/**
 *getDisponibiliteCount.js
 */

const response = require('../../utils/response');
/**
 * @description : returns total number of records of disponibilite
...
const getDisponibiliteCount = ({
  ...
  let count = await disponibiliteDb.count(where);
  return response.success({ data: { count } });
};
module.exports = getDisponibiliteCount;
...
const regionController = require('../../../controller/device/v1/region');
const {
...
router.route('/device/api/v1/region/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,regionController.getRegionById);

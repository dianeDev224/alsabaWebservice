...
const Chat_messageController = require('../../../controller/device/v1/Chat_message');
const {
...
router.route('/device/api/v1/chat_message/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,Chat_messageController.getChat_messageById);

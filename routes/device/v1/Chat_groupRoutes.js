...
const Chat_groupController = require('../../../controller/device/v1/Chat_group');
const {
...
router.route('/device/api/v1/chat_group/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,Chat_groupController.getChat_groupById);

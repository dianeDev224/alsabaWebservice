...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Shanna57',
      password: 'ds3yYQzY8qKZUe7',
      email: 'Dayton.Murazik8@gmail.com',
      name: 'Dr. Alejandro Lowe',
      userType: 351,
      phoneNumber: 'Functionality',
      mobileNo: '(973) 585-1907',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 694,
      loginReactiveTime: '2024-04-01T07:04:17.005Z',
      id: '654db2f6c2e07103f19c0ba7'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Christopher_Hudson81',
        'password':'Tkw_NtEbni3osjv',
        'email':'Mitchell.Pfannerstill99@yahoo.com',
        'name':'Scott Streich',
        'userType':authConstant.USER_TYPES.AdminSenior,
        'phoneNumber':'brand',
        'mobileNo':'(647) 697-5207',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/desktop/auth/forgot-password')
      .send({ 'email':'Mitchell.Pfannerstill99@yahoo.com', });

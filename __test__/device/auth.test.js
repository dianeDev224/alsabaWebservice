...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Vince.Bayer',
      password: 'VR5vDwae_1hhhmD',
      email: 'Damien51@yahoo.com',
      name: 'Leslie Hoppe',
      userType: 158,
      phoneNumber: 'generate',
      mobileNo: '(414) 040-0155',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 643,
      loginReactiveTime: '2024-03-28T01:51:05.551Z',
      id: '654db2f6c2e07103f19c0a51'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Edwardo21',
        'password':'3GYqPk3NODh7EaP',
        'email':'Omer93@gmail.com',
        'name':'Latoya Renner',
        'userType':authConstant.USER_TYPES.AdminSenior,
        'phoneNumber':'Universal',
        'mobileNo':'(817) 680-4627',
